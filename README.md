...
# User-Manager-GUI
This graphical user interface facilitates the managing of users of a professional internal system, built as a personal project to practice UI/UX concepts.
